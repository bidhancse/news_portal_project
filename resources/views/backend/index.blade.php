...
<head>
    ...
    <title>NewsBD || Admin Dashboard </title>
    <!-- Favicon icon -->
    ...
    <!--toast-->
    <link href="{{ asset('public/backend')}}/css/toast.css" rel="stylesheet">
...
<body>
    ...
    <!--**********************************
        ...
        <!--**********************************
            ...
            ***********************************-->
            <div class="nav-header">
            	<a href="{{ url('/backend') }}" class="brand-logo">
            				...
            				<ul class="navbar-nav header-right main-notification">
            					...
            					<li class="nav-item dropdown header-profile">
            						<a class="nav-link" href="#" role="button" data-toggle="dropdown">
            							<img src="{{ Auth()->user()->image }}" width="20" alt="" style="border-radius: 50px;">
        ...
        <!--**********************************
            ...
            ***********************************-->
            <div class="deznav">
            	<div class="deznav-scroll">
            		<ul class="metismenu" id="menu">
                       ...
                       <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <span class="nav-text">Admin Information</span>
                    </a>
                    <ul aria-expanded="false">
                        <li><a href="{{ url('Create-Admin') }}">Create Admin</a></li>
                ...
                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                   <i class="flaticon-077-menu-1"></i>
                   <span class="nav-text">Item Information</span>
               </a>
               <ul aria-expanded="false">
                   <li><a href="{{ url('Item') }}">Item</a></li>
                   <li><a href="{{ url('Manage-Item')}}">Manage Item</a></li>
               </ul>
           </li>

           <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              <i class="flaticon-077-menu-1"></i>
              <span class="nav-text">Category Information</span>
          </a>
          <ul aria-expanded="false">
      ...
      <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
         <i class="flaticon-077-menu-1"></i>
         <span class="nav-text">News Information</span>
     </a>
     <ul aria-expanded="false">
         <li><a href="{{ url('News') }}">News</a></li>
         <li><a href="{{ url('Manage-News')}}">Manage News</a></li>
     </ul>
 </li>
